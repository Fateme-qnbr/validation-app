...
const HomePage = () => {
  return (
    <div className="md:flex md:flex-row md:mx-16 md:justify-around flex flex-col-reverse justify-center items-center">
      <div className="sm:w-[545px] w-96 md:my-5 my-3 md:px-7 px-5">
        ...
        <button className="md:mx-7 mx-4 md:mt-10 mt-5 md:py-3 py-2 md:px-12 px-9  lg:text-2xl text-xl text-white bg-discogreenver-text">
          EXPLORE NOW
        </button>
      </div>
      ...
      <div>
        <img
          className="md:box-content md:size-[467px] md:px-6 md:py-24 right-0 size-[424px] mt-12 px-4  "
          src={Home}
        />
      </div>
    </div>
